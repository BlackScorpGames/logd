...
if ($dkills-$dp > 1) {
	...
	output::doOutput("How do you wish to spend them?`n`n");
	output::doOutput("Be sure that your allocations add up to your total unspent dragon points.");
	...
	output::doOutput("How do you wish to spend it?`n`n");
	output::doOutput("You earn one dragon point each time you slay the dragon.");
	output::doOutput("Advancements made by spending dragon points are permanent!");
		...
		output::doOutput("`n`nCurrently, the dragon points you have already spent are distributed in the following manner.");
